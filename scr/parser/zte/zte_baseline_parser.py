...
def prepare_oracle_table_4g(oracle_con, oracle_cur, frequency_type, field_mapping_dic, base_mapping_dic, red_mapping_dic, base_mapping_2600_dic, base_mapping_redzone_2600_dic, base_mapping_900_anchor_dic, base_mapping_1800_anchor_dic, base_mapping_2100_anchor_dic, base_mapping_2600_anchor_dic,  drop_param=True, baseline_label_dic={}):
	for group_param in field_mapping_dic:
		table_name = naming_helper.get_table_name(BASELINE_TABLE_PREFIX.format(ZTE_TABLE_PREFIX), frequency_type, group_param)
