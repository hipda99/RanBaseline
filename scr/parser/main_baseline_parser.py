            ...
            try:
                ...
                if vendor == ZTE_VENDOR:
                    ...
                    if source.FrequencyType == "4G":
                        ...
                        field_mapping_dic, base_mapping_900_dic, base_mapping_1800_dic, base_mapping_2100_dic, param_cell_level_dic, param_mo_dic, base_mapping_label_dic = field_mapping_parser.read_mapping(vendor, source.FileMappingPath, source.FrequencyType, source.Frequency)
